  ...
  const fetchStatistics = async () => {
    try {
      ...
      const processedStats = {
        ...
        categories: {
          highly_qualified: candidates.filter(c => c.final_score >= 80).length,
          qualified: candidates.filter(c => c.final_score >= 65 && c.final_score < 80).length,
          not_a_fit: candidates.filter(c => c.final_score < 65).length
        },
        average_scores: {
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          AI-powered candidate evaluation and intelligent screening
        </p>
      </motion.div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  Add new candidate for analysis
                </p>
              </div>
            ...
            recentCandidates.map((candidate, index) => (
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  <span
                    className={`badge ${getCategoryColor(candidate.analysis?.category)}`}
                  >
