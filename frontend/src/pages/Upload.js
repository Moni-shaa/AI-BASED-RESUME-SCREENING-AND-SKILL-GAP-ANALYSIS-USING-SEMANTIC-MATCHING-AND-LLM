  ...
  const features = [
    {
      ...
      description:
        "Advanced AI models analyze resumes for skills, experience, and fit",
      color: "primary",
    },
    {
      icon: Zap,
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Upload a resume and let our AI provide comprehensive candidate
          analysis with bias detection
        </p>
      </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                View detailed analysis and bias detection
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <ul className="space-y-2 text-sm text-primary-800">
          ...
          <li>
            • PDF files generally provide better text extraction than DOCX
          </li>
          <li>
            • Our AI works best with resumes that include skills, experience,
